...
class Users(ViewSet):
    """Users for gameapp
    Author: Dustin Hobson
    Purpose: Allow a user to communicate with the gameApp database to GET PUT POST and DELETE Users.
...
"""
    ...
    def retrieve(self, request, pk=None):
        ...
        Author: Dustin Hobson
        Purpose: Allow a user to communicate with the gameApp database to retrieve  one user
        Methods:  GET
        Returns:
